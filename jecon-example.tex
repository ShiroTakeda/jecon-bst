...
\begin{itemize}
 ...
 \item ひらがなで書くケース
       ...
       \end{itemize}
 \item \texttt{yomi} フィールドではなく、\texttt{sortname} フィールドを使っても
       同じです。\texttt{sortname} フィールドは biblatex で同じような機能として
       利用されるので、biblatex 用にもデータベースを利用したい人は \texttt{yomi}
       ではなく \texttt{sortname} を使うのがよいと思います。
 \item その他
       \begin{itemize}
