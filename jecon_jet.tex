...
% Time-stamp:	       <2016-02-23 10:05:27 st>
%
%############################## Main #################################
...
\verb|\bibliographystyle| にデフォールトの \verb|jecon_jet.bst| を指定し、さらに
\verb|natbib|のオプションに\verb|numbers|を指定している。JET (\textit{Journal of
Economic Theory})風のスタイル。
\vspace{1em}\\
